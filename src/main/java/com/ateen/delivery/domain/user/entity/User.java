...
public class User extends BaseEntity {
    ...
    @Builder
    public User(String email, String password, String name, String phoneNum, Address address, String nickname, LocalDate birthDay, UserType userType) {
        this.email = email;
